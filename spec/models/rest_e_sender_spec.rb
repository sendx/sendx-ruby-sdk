...
# Unit tests for SendX::RestESender
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestESender do
  let(:instance) { SendX::RestESender.new }

  describe 'test an instance of RestESender' do
    it 'should create an instance of RestESender' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestESender)
    end
  end
