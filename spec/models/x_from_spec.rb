...
# Unit tests for SendX::XFrom
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::XFrom do
  let(:instance) { SendX::XFrom.new }

  describe 'test an instance of XFrom' do
    it 'should create an instance of XFrom' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::XFrom)
    end
  end
