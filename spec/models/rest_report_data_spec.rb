...
# Unit tests for SendX::RestReportData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestReportData do
  let(:instance) { SendX::RestReportData.new }

  describe 'test an instance of RestReportData' do
    it 'should create an instance of RestReportData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestReportData)
    end
  end
