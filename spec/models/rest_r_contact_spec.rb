...
# Unit tests for SendX::RestRContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestRContact do
  let(:instance) { SendX::RestRContact.new }

  describe 'test an instance of RestRContact' do
    it 'should create an instance of RestRContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestRContact)
    end
  end
  ...
  describe 'test attribute "page_source"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
