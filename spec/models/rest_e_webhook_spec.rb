...
# Unit tests for SendX::RestEWebhook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestEWebhook do
  let(:instance) { SendX::RestEWebhook.new }

  describe 'test an instance of RestEWebhook' do
    it 'should create an instance of RestEWebhook' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestEWebhook)
    end
  end
