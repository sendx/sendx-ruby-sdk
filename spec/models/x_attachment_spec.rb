...
# Unit tests for SendX::XAttachment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::XAttachment do
  let(:instance) { SendX::XAttachment.new }

  describe 'test an instance of XAttachment' do
    it 'should create an instance of XAttachment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::XAttachment)
    end
  end
