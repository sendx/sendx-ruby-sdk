...
# Unit tests for SendX::LinkStat
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::LinkStat do
  let(:instance) { SendX::LinkStat.new }

  describe 'test an instance of LinkStat' do
    it 'should create an instance of LinkStat' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::LinkStat)
    end
  end
