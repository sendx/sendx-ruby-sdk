...
# Unit tests for SendX::RestRCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestRCampaign do
  let(:instance) { SendX::RestRCampaign.new }

  describe 'test an instance of RestRCampaign' do
    it 'should create an instance of RestRCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestRCampaign)
    end
  end
  ...
  describe 'test attribute "schedule_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
