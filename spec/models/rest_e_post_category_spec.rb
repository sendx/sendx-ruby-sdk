...
# Unit tests for SendX::RestEPostCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestEPostCategory do
  let(:instance) { SendX::RestEPostCategory.new }

  describe 'test an instance of RestEPostCategory' do
    it 'should create an instance of RestEPostCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestEPostCategory)
    end
  end
