...
# Unit tests for SendX::RestRMember
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestRMember do
  let(:instance) { SendX::RestRMember.new }

  describe 'test an instance of RestRMember' do
    it 'should create an instance of RestRMember' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestRMember)
    end
  end
