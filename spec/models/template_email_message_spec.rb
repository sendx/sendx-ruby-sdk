...
# Unit tests for SendX::TemplateEmailMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::TemplateEmailMessage do
  let(:instance) { SendX::TemplateEmailMessage.new }

  describe 'test an instance of TemplateEmailMessage' do
    it 'should create an instance of TemplateEmailMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::TemplateEmailMessage)
    end
  end
