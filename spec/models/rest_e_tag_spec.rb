...
# Unit tests for SendX::RestETag
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestETag do
  let(:instance) { SendX::RestETag.new }

  describe 'test an instance of RestETag' do
    it 'should create an instance of RestETag' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestETag)
    end
  end
