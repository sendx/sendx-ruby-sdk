...
# Unit tests for SendX::RestEPostTag
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestEPostTag do
  let(:instance) { SendX::RestEPostTag.new }

  describe 'test an instance of RestEPostTag' do
    it 'should create an instance of RestEPostTag' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestEPostTag)
    end
  end
