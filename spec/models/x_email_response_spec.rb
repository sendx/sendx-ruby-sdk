...
# Unit tests for SendX::XEmailResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::XEmailResponse do
  let(:instance) { SendX::XEmailResponse.new }

  describe 'test an instance of XEmailResponse' do
    it 'should create an instance of XEmailResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::XEmailResponse)
    end
  end
