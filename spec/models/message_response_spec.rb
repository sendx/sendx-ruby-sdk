...
# Unit tests for SendX::MessageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::MessageResponse do
  let(:instance) { SendX::MessageResponse.new }

  describe 'test an instance of MessageResponse' do
    it 'should create an instance of MessageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::MessageResponse)
    end
  end
