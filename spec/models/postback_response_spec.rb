...
# Unit tests for SendX::PostbackResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::PostbackResponse do
  let(:instance) { SendX::PostbackResponse.new }

  describe 'test an instance of PostbackResponse' do
    it 'should create an instance of PostbackResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::PostbackResponse)
    end
  end
