...
# Unit tests for SendX::XEmailMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::XEmailMessage do
  let(:instance) { SendX::XEmailMessage.new }

  describe 'test an instance of XEmailMessage' do
    it 'should create an instance of XEmailMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::XEmailMessage)
    end
  end
