...
# Unit tests for SendX::RestECampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestECampaign do
  let(:instance) { SendX::RestECampaign.new }

  describe 'test an instance of RestECampaign' do
    it 'should create an instance of RestECampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestECampaign)
    end
  end
  ...
  describe 'test attribute "html_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
