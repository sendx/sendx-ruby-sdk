...
# Unit tests for SendX::XTo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::XTo do
  let(:instance) { SendX::XTo.new }

  describe 'test an instance of XTo' do
    it 'should create an instance of XTo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::XTo)
    end
  end
