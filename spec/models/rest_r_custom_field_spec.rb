...
# Unit tests for SendX::RestRCustomField
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestRCustomField do
  let(:instance) { SendX::RestRCustomField.new }

  describe 'test an instance of RestRCustomField' do
    it 'should create an instance of RestRCustomField' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestRCustomField)
    end
  end
