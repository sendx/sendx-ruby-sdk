...
# Unit tests for SendX::RestEContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestEContact do
  let(:instance) { SendX::RestEContact.new }

  describe 'test an instance of RestEContact' do
    it 'should create an instance of RestEContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestEContact)
    end
  end
