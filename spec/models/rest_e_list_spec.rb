...
# Unit tests for SendX::RestEList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestEList do
  let(:instance) { SendX::RestEList.new }

  describe 'test an instance of RestEList' do
    it 'should create an instance of RestEList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestEList)
    end
  end
