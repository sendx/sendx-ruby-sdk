...
# Unit tests for SendX::RestRList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestRList do
  let(:instance) { SendX::RestRList.new }

  describe 'test an instance of RestRList' do
    it 'should create an instance of RestRList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestRList)
    end
  end
