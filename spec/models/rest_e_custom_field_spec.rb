...
# Unit tests for SendX::RestECustomField
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestECustomField do
  let(:instance) { SendX::RestECustomField.new }

  describe 'test an instance of RestECustomField' do
    it 'should create an instance of RestECustomField' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestECustomField)
    end
  end
