...
# Unit tests for SendX::RestETemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SendX::RestETemplate do
  let(:instance) { SendX::RestETemplate.new }

  describe 'test an instance of RestETemplate' do
    it 'should create an instance of RestETemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SendX::RestETemplate)
    end
  end
