...
# Unit tests for SendX::EventsApi
...
describe 'EventsApi' do
  ...
  describe 'test an instance of EventsApi' do
    it 'should create an instance of EventsApi' do
      expect(@api_instance).to be_instance_of(SendX::EventsApi)
    end
  end

  # unit tests for track_custom_event
  # Track custom event
  # Records custom events for advanced tracking. 
  # @param custom_event_request 
  # @param [Hash] opts the optional parameters
  # @return [EventResponse]
  describe 'track_custom_event test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for track_revenue_event
  # Track revenue event
  # Records revenue events for analytics and attribution. 
  # @param revenue_event_request 
  # @param [Hash] opts the optional parameters
  # @return [EventResponse]
  describe 'track_revenue_event test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
