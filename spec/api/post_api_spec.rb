...
describe 'PostApi' do
  ...
  describe 'test an instance of PostApi' do
    it 'should create an instance of PostApi' do
      expect(@api_instance).to be_instance_of(SendX::PostApi)
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Integer] :offset Number of posts to skip
  # @option opts [Integer] :limit Maximum number of posts to return
