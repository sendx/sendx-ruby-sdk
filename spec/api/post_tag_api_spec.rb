...
# Unit tests for SendX::PostTagApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PostTagApi' do
  before do
  ...
  describe 'test an instance of PostTagApi' do
    it 'should create an instance of PostTagApi' do
      expect(@api_instance).to be_instance_of(SendX::PostTagApi)
    end
  end

  # unit tests for create_post_tag
  # Create post tag
  # Creates a new tag for blog posts. 
  # @param rest_e_post_tag 
  # @param [Hash] opts the optional parameters
  # @return [RestRPostTag]
  describe 'create_post_tag test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_post_tag
  # Delete post tag
  # Soft deletes a post tag. 
  # @param identifier The unique post tag identifier to retrieve. - &#x60;post_tag_leBDiFdrUnRmRz4nfopSrv&#x60; 
  # @param [Hash] opts the optional parameters
  # @return [MessageResponse]
  describe 'delete_post_tag test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_all_post_tags
  # Get all post tags
  # Retrieves all blog post tags. 
  # @param [Hash] opts the optional parameters
  # @return [Array<RestRPostTag>]
  describe 'get_all_post_tags test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_post_tag
  # Get post tag by ID
  # Retrieves a specific post tag. 
  # @param identifier The unique post tag identifier to retrieve. - &#x60;post_tag_leBDiFdrUnRmRz4nfopSrv&#x60; 
  # @param [Hash] opts the optional parameters
  # @return [RestRPostTag]
  describe 'get_post_tag test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_post_tag
  # Update post tag
  # Updates a post tag. 
  # @param rest_e_post_tag 
  # @param identifier The unique post tag identifier to retrieve. - &#x60;post_tag_leBDiFdrUnRmRz4nfopSrv&#x60; 
  # @param [Hash] opts the optional parameters
  # @return [RestRPostTag]
  describe 'update_post_tag test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
