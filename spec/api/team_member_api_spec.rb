...
# Unit tests for SendX::TeamMemberApi
...
describe 'TeamMemberApi' do
  ...
  describe 'test an instance of TeamMemberApi' do
    it 'should create an instance of TeamMemberApi' do
      expect(@api_instance).to be_instance_of(SendX::TeamMemberApi)
    end
  end

  # unit tests for get_all_team_members
  # Get all team members
  # Retrieves all team members.
  # @param [Hash] opts the optional parameters
  # @return [Array<RestRMember>]
  describe 'get_all_team_members test' do
    it 'should work' do
