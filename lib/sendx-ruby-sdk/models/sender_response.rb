  ...
  class SenderResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SendX::SenderResponse` initialize method"
      end
      ...
      if attributes.key?(:'is_whitelisted')
        self.is_whitelisted = attributes[:'is_whitelisted']
      else
        self.is_whitelisted = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_whitelisted.nil?
        invalid_properties.push('invalid value for "is_whitelisted", is_whitelisted cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_whitelisted.nil?
      true
    end
    ...
    def hash
      [id, name, email, is_whitelisted].hash
    end
