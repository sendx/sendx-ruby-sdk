...
module SendX
  class DashboardStats
    attr_accessor :last_email_campaign_stat

    # Number of newsletters sent.
    attr_accessor :newsletter_count

    # Number of automations set up.
    attr_accessor :automation_count
    ...
    def self.openapi_types
      {
        :'last_email_campaign_stat' => :'LastSentCampaignStat',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SendX::DashboardStats` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SendX::DashboardStats`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'last_email_campaign_stat')
        self.last_email_campaign_stat = attributes[:'last_email_campaign_stat']
      end

      if attributes.key?(:'newsletter_count')
        self.newsletter_count = attributes[:'newsletter_count']
      end

      if attributes.key?(:'automation_count')
        self.automation_count = attributes[:'automation_count']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          last_email_campaign_stat == o.last_email_campaign_stat &&
          newsletter_count == o.newsletter_count &&
          automation_count == o.automation_count
    end
    ...
    def hash
      [last_email_campaign_stat, newsletter_count, automation_count].hash
    end
