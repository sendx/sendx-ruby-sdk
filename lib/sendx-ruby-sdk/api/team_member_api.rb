...
module SendX
  class TeamMemberApi
    ...
    # @return [Array<RestRMember>]
    def get_all_team_members(opts = {})
      data, _status_code, _headers = get_all_team_members_with_http_info(opts)
      data
    end
    ...
    # Retrieves all team members.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<RestRMember>, Integer, Hash)>] Array<RestRMember> data, response status code and response headers
    def get_all_team_members_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamMemberApi.get_all_team_members ...'
      end
      # resource path
      local_var_path = '/team/member'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<RestRMember>'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['TeamApiKey']

      new_options = opts.merge(
        :operation => :"TeamMemberApi.get_all_team_members",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeamMemberApi#get_all_team_members\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [RestRMember]
    def get_team_member(identifier, opts = {})
      data, _status_code, _headers = get_team_member_with_http_info(identifier, opts)
      data
    end
    ...
    # @param identifier [String] Resource identifier with prefix (e.g., &#x60;contact_BnKjkbBBS500CoBCP0oChQ&#x60;)  **Format:** &#x60;&lt;prefix&gt;_&lt;22-character-id&gt;&#x60; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(RestRMember, Integer, Hash)>] RestRMember data, response status code and response headers
    def get_team_member_with_http_info(identifier, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamMemberApi.get_team_member ...'
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling TeamMemberApi.get_team_member"
      end
      pattern = Regexp.new(/^[a-z_]+_[a-zA-Z0-9]{22}$/)
      if @api_client.config.client_side_validation && identifier !~ pattern
        fail ArgumentError, "invalid value for 'identifier' when calling TeamMemberApi.get_team_member, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/team/member/{identifier}'.sub('{' + 'identifier' + '}', CGI.escape(identifier.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RestRMember'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['TeamApiKey']

      new_options = opts.merge(
        :operation => :"TeamMemberApi.get_team_member",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeamMemberApi#get_team_member\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
