...
module SendX
  class EventsApi
    ...
    def track_custom_event(custom_event_request, opts = {})
      data, _status_code, _headers = track_custom_event_with_http_info(custom_event_request, opts)
      data
    end
    ...
    def track_custom_event_with_http_info(custom_event_request, opts = {})
      ...
      if @api_client.config.client_side_validation && custom_event_request.nil?
        fail ArgumentError, "Missing the required parameter 'custom_event_request' when calling EventsApi.track_custom_event"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [EventResponse]
    def track_revenue_event(revenue_event_request, opts = {})
      data, _status_code, _headers = track_revenue_event_with_http_info(revenue_event_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(EventResponse, Integer, Hash)>] EventResponse data, response status code and response headers
    def track_revenue_event_with_http_info(revenue_event_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventsApi.track_revenue_event ...'
      end
      ...
      if @api_client.config.client_side_validation && revenue_event_request.nil?
        fail ArgumentError, "Missing the required parameter 'revenue_event_request' when calling EventsApi.track_revenue_event"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EventsApi.track_revenue_event",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventsApi#track_revenue_event\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
